...
3. Read [ADR-045](../adr/ADR-045-governance-lifecycle-and-state-machine-specification.md) for the governance lifecycle.
4. Run `synth doctor` in a checkout to verify the environment.
5. Explore `docs/expeditions/` for examples of chartered work.
