...
- [ADR-041 — Certification Framework](ADR-041-certification-framework.md)
- [ADR-042 — AI Agent Governance Validation Boundary](ADR-042-ai-agent-governance-validation-boundary.md)
- [ADR-043 — AI Agent Validation Scope Boundary](ADR-043-ai-agent-validation-scope-boundary.md)
- [ADR-044 — External Build Systems Are Adapters](ADR-044-external-build-systems-are-adapters.md)
- [ADR-045 — Governance Lifecycle State Machine](ADR-045-governance-lifecycle-state-machine.md)
- [ADR-046 — Implementation Authority Ordering](ADR-046-implementation-authority-ordering.md)
- [ADR-047 — Intent Refinement and Alignment Governance](ADR-047-intent-refinement-and-alignment-governance.md)
- [ADR-048 — Genesis Lifecycle and Alignment Contracts](ADR-048-genesis-lifecycle-and-alignment-contracts.md)
- [ADR-049 — Repository Quality Audit Framework](ADR-049-repository-quality-audit-framework.md)
- [ADR-050 — Execution Gate State Dependency Enforcement](ADR-050-execution-gate-state-dependency-enforcement.md)
