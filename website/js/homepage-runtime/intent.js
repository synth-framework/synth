...
function detectKeywords(normalized, dictionary) {
    const found = new Set();
...
function deriveSuccessCriteria(goals) {
...
function computeConfidence(intent, discovery) {
    const byField = {
...
export function extractIntent(input, mode) {
...
export function discoverIntent(intent) {
...
export function generateUnknowns(intent, discovery) {
    const items = [];
...
export function generateDomain(intent, discovery) {
    const normalized = normalizeInput(intent.description);
    const entities = [];
...
export function generateMission(intent, discovery, domain) {
...
export function generateExpeditions(mission, discovery) {
    const base = [
        {
            kind: "expedition",
...
export function generateEvidence(intent, discovery) {
    return [
        {
            kind: "evidence",
