...
export function createPublicFlowState() {
    return {
...
function buildActions(state, currentStep) {
    const actions = [];
    switch (currentStep) {
        case "understanding":
